 ...
 */
export const TYPEQL_RESERVED_WORDS: ReadonlySet<string> = new Set([
  // ============================================================
  // Schema queries
  // ============================================================
 ...
 */
export function getReservedWords(): ReadonlySet<string> {
 ...
 * @returns True if the name is a reserved word (case-insensitive)
 */
export function isReservedWord(name: string): boolean {
  return TYPEQL_RESERVED_WORDS.has(name.toLowerCase());
}
